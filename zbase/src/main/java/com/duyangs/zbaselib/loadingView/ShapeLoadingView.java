...
public class ShapeLoadingView extends View {
    ...
    private void init(Context context) {
        mTriangleColor = getColor(context, R.color.loading_triangle);
        mCircleColor =getColor(context, R.color.loading_circle);
        mRectColor = getColor(context, R.color.loading_rect);
        mPaint = new Paint();
